package com.homechart.app.smartrefreshlayout.header;
...
public class MyStoreHouseHeader extends View implements RefreshHeader {
    ...
    public MyStoreHouseHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs, 0);
    }

    public MyStoreHouseHeader(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        setBackgroundColor(0xff333333);
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.scwang.smartrefresh.header.R.styleable.StoreHouseHeader);
        mLineWidth = ta.getDimensionPixelOffset(com.scwang.smartrefresh.header.R.styleable.StoreHouseHeader_shhLineWidth, mLineWidth);
        if (ta.hasValue(com.scwang.smartrefresh.header.R.styleable.StoreHouseHeader_shhText)) {
            initWithString(ta.getString(com.scwang.smartrefresh.header.R.styleable.StoreHouseHeader_shhText));
        } else {
            initWithString("ceshi");
        }
        ta.recycle();
    }
    ...
    public MyStoreHouseHeader setLoadingAniDuration(int duration) {
        mLoadingAniDuration = duration;
        mLoadingAniSegDuration = duration;
        return this;
    }

    public MyStoreHouseHeader setLineWidth(int width) {
        mLineWidth = width;
    ...
    public MyStoreHouseHeader setTextColor(int color) {
        mTextColor = color;
        for (int i = 0; i < mItemList.size(); i++) {
    ...
    public MyStoreHouseHeader setDropHeight(int height) {
        mDropHeight = height;
        return this;
    }

    public MyStoreHouseHeader initWithString(String str) {
        initWithString(str, 20);
        return this;
    }

    public MyStoreHouseHeader initWithString(String str, int fontSize) {
        ArrayList<float[]> pointList = StoreHousePath.getPath(str, fontSize * 0.01f, 14);
        initWithPointList(pointList);
        return this;
    }

    public MyStoreHouseHeader initWithStringArray(int id) {
    ...
    public MyStoreHouseHeader setScale(float scale) {
        mScale = scale;
        return this;
    }

    public MyStoreHouseHeader initWithPointList(ArrayList<float[]> pointList) {
