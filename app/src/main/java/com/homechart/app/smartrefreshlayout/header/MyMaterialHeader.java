...
public class MyMaterialHeader extends ViewGroup implements RefreshHeader {
    ...
    public MyMaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.scwang.smartrefresh.header.R.styleable.MaterialHeader);
        mShowBezierWave = ta.getBoolean(com.scwang.smartrefresh.header.R.styleable.MaterialHeader_mhShowBezierWave, mShowBezierWave);
        mBezierPaint.setColor(ta.getColor(com.scwang.smartrefresh.header.R.styleable.MaterialHeader_mhPrimaryColor, 0xff11bbff));
        if (ta.hasValue(com.scwang.smartrefresh.header.R.styleable.MaterialHeader_mhShadowRadius)) {
            int radius = ta.getDimensionPixelOffset(com.scwang.smartrefresh.header.R.styleable.MaterialHeader_mhShadowRadius, 0);
            int color = ta.getColor(com.scwang.smartrefresh.header.R.styleable.MaterialHeader_mhShadowColor, 0xff000000);
...
//                resolveSize(getSuggestedMinimumHeight(), heightMeasureSpec));
    ...
    //<editor-fold desc="API">
    public MyMaterialHeader setColorSchemeColors(int... colors) {
        mProgress.setColorSchemeColors(colors);
        return this;
    }
    //</editor-fold>
